<div class="page-content account-cont">
    ...
    <div class="row-fluid visible-when-content-ready">
        ...
        <div id="orderBoxDesk" class="order-box span12">
        ...
        <div id="orderBoxMobile" class="order-box col-sm-6 col-xs-12 dos">
            ...
            <div class="wrapper">
                ...
                <div class="row no-gutter last">
                    <a class="checkout-link button" href="{{ order.checkout_url | add_param('ref', 'orders_list') }}" target="_blank">{{'Realizar el pago >' | translate}}</a>
                </div>
            </div>
            {% endfor %}
        </div>
