<div class="page-content">
    ...
    <div class="addresses visible-when-content-ready">
        <ul>
            ...
            <a class="submit_button m-top m-bottom" href="{{ store.customer_new_address_url }}"> {{ 'Agregar una nueva dirección' | translate }} </a>
    </div>
</div>
