        ...
        <div class="row-fluid">
            <div class='{% if "newsletter_image.jpg" | has_custom_image %}span7{% else %}span12{% endif %}'>
                ...
                <div id="newsletter-popup">
                    ...
                    <div style='display: none;' class="contact-ok alert alert-success">{{ "Se inscribió al newsletter correctamente." | translate }}</div>
                    <div style='display: none;'class="contact-error alert alert-danger">{{ "Ingresa tu email" | translate }}</div>
                </div>
            </div>
